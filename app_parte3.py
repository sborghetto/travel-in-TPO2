...
#agrego este código despues de la definición de la clase Carrito        
app = Flask(__name__)
CORS(app)
...
def obtener_producto(codigo):
    ...
    if producto:
        ...
        }), 200 #codigo de estado (200-300) ok
    return jsonify({'message': 'Producto no encontrado.'}), 404 #codigo de estado (404 not found)
